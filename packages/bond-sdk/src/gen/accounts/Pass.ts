...
export class Pass {
  ...
  static readonly discriminator = Buffer.from([40, 247, 140, 113, 56, 14, 57, 44]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<Pass | null> {
