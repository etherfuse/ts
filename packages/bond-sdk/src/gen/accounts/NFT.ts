...
export class NFT {
  ...
  static readonly discriminator = Buffer.from([88, 10, 146, 176, 101, 11, 40, 217]);

  static readonly layout = borsh.struct([borsh.publicKey('mint'), borsh.u8('bump'), borsh.u64('counter')]);
  ...
  static async fetch(c: Connection, address: PublicKey, programId: PublicKey = PROGRAM_ID): Promise<NFT | null> {
