...
export class GlobalPassConfig {
  ...
  static readonly discriminator = Buffer.from([229, 188, 90, 13, 60, 254, 80, 236]);

  static readonly layout = borsh.struct([borsh.publicKey('collectionOwner'), borsh.u8('bump')]);
